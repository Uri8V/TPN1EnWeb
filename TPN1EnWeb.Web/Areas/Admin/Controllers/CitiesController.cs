        ...
        public IActionResult Index(int? page, string? searchTerm, bool viewAll = false, int pageSize = 10)
        {
            ...
            if (string.IsNullOrEmpty(searchTerm) || viewAll)
            {
                cities = _service?
                    ...
                    propertiesNames: "Country,State", filter: c => c.CountryId == 11);
        ...
        public IActionResult UpSert(int? id)
        {
            ...
            if (id == null || id == 0)
            {
                ...
                cityVm.Countries = _countriesService!
                    .GetAll(orderBy: q => q.OrderBy(c => c.CountryName), filter: c => c.CountryId == 11)
                ...
                cityVm.States = _statesService!
                    .GetAll(filter: c => c.CountryId == 11 || c.CountryId == 253)
