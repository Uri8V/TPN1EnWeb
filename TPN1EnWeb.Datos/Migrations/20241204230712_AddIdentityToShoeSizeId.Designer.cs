...
namespace TPN1EnWeb.Datos.Migrations
{
    ...
    [Migration("20241204230712_AddIdentityToShoeSizeId")]
    partial class AddIdentityToShoeSizeId
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TPN1EnWeb.Entidades.OrderDetail", b =>
                {
                    ...
                    b.Property<int?>("ShoeSizesShoeSizeId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ShoeSizesShoeSizeId");
            ...
            modelBuilder.Entity("TPN1EnWeb.Entidades.OrderDetail", b =>
                {
                    ...
                    b.HasOne("TPN1EnWeb.Entidades.ShoeSizes", "ShoeSizes")
                        .WithMany()
                        .HasForeignKey("ShoeSizesShoeSizeId");
